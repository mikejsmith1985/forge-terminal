...
- **MBL2PC portfolio device label now says PC** — Simplified the mocked sender label from "Work PC" to "PC" in the portfolio copy and refreshed MBL2PC screenshots so the device naming stays concise.
