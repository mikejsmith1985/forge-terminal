...
### Added
- **Projects card folders now support right-click Copy Path** — Right-click any folder in the Projects browser to copy its full path without changing the active terminal directory.
