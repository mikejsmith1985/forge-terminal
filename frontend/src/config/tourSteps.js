...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    content: 'Click "Files" to open the Lens File Picker - an intelligent context builder with three views: 🔥 Heatmap (recent activity), 📊 Graph (dependencies), and 🔎 Search (fuzzy find).',
    placement: 'left',
    spotlight: true,
    action: 'showFilesTab', // Switch to Files tab
  },
  {
    id: 'files-context-cart',
    selector: '.lens-file-picker, .lens-context-cart',
    fallbackSelector: '.sidebar-content',
    title: 'Context Cart 🛒',
    content: 'Select files from any view to add them to your Context Cart with real-time token counting (128k budget). Perfect for building the perfect context for your AI sessions!',
    placement: 'left',
    spotlight: true,
  },
  {
  ...
  },
  {
    ...
    title: 'You\'re Ready! 🚀',
    content: 'Try these features: Ctrl+/ for Forge Assist (Tab for Task Mode!), browse files in the Files tab, or right-click tabs for AM logging. Replay this tour anytime from Settings → Shell.',
    placement: 'center',
    spotlight: false,
    isFinal: true,
  },
