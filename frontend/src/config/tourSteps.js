...
const TOUR_STEPS = [
...

  {
    ...
    content: 'Press Ctrl+I to open the Persistent Instruction bar - a floating input that lets you add custom context to any CLI prompt. Works with gh copilot, claude, aider, and more! Configure your instruction template in Settings.',
    placement: 'center',
    spotlight: true,
    arrow: 'down-right',
