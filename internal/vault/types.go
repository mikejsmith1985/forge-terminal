...
// (GET /api/vault/entries/value) ΓÇö this returns a single decrypted value only
...
// It intentionally omits the secret value ΓÇö use GetAutoInjectEnv for
...
// SecretValue is accepted here and immediately encrypted ΓÇö it is never stored
...
// ΓöÇΓöÇ Internal disk types ΓÇö never serialized to the API ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
