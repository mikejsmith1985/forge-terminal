...
// before the PTY process starts — completely invisible to terminal output.
package vault
...
// — the variable values are never echoed.
func buildPowerShellScript(envVars map[string]string, randomSuffix string) (string, error) {
	...
	scriptBuilder.WriteString("# Forge Vault injection script — auto-generated, do not edit\n")
