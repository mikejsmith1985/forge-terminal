...
echo -e "  • GitHub Release was created from the local release pipeline"
echo -e "  • Confirm the release assets at: ${CYAN}https://github.com/mikejsmith1985/forge-terminal/releases${NC}"
echo ""
